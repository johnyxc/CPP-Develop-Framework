...
//	避免和华迈SDK全局重载new冲突
TiXmlElement* _xml_create_TiXmlElement(char const* name);
TiXmlText* _xml_create_TiXmlText(char const* text);
TiXmlDocument* _xml_create_TiXmlDocument();
void _xml_delete_TiXmlDocument(TiXmlDocument* self);
TiXmlDeclaration*	_xml_create_TiXmlDeclaration(char const* ver, char const* enc, char const* standdalone);
